...
const Signup = () => {
    ...
    const {user, createUser, updateUser, signInWithGoogle, verifyEmail, loading, setLoading} = useContext(AuthContext)
    ...
    const handleSubmit = event =>{
        ...
        const url = "https://api.imgbb.com/1/upload?key=f1059148bb4099067a365938ad912e7b"
        fetch(url, {
            method: 'POST',
            body: formdata
        })
